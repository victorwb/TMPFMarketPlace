          ...
          <div class="row">
            <div class="col-lg-9">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="{{route('manufacturer.update', [$manufacturer->id])}}" method="POST" enctype="multipart/form-data">@csrf
                  {{method_field('PUT')}}
                    <div class="form-group">
                      ...
                      value="{{$manufacturer->name}}" name="name">
                        @error('name')
                    ...
                    <div class="form-group">
                      ...
                      value="{{$manufacturer->description}}" name="description">
                        @error('description')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{$message}}</strong>
                        </span>
                    ...
                    <div class="form-group">
                      <div class="custom-file">
                        ...
                        <img src="{{Storage::url($manufacturer->image)}}" width='150'/>
                        <br/><br/>
                      </div>
                    </div>
