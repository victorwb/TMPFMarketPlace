    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <a href="{{route('sub.create')}}" class="btn btn-info mb-1">Add new</a>
          <!-- Row -->
</div>
          <div class="row">
                  ...
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <th><a href="{{route('sub.edit',[$item->id])}}" class="btn btn-secondary mb-1">edit</a></th>
                        <th><form action="{{route('sub.destroy',[$item->id])}}" method="POST"
