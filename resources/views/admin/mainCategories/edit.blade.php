          ...
          <div class="row">
            <div class="col-lg-9">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="{{route('main.update', [$maincategory->id])}}" method="POST" enctype="multipart/form-data">@csrf
                  {{method_field('PUT')}}
                    <div class="form-group">
                      ...
                      value="{{$maincategory->name}}" name="name">
                        @error('name')
                    ...
                    <div class="form-group">
                      ...
                      value="{{$maincategory->description}}" name="description">
                        @error('description')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{$message}}</strong>
                        </span>
